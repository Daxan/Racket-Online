...
(define (tutorial request)
  ...
  (make-response
   (match page
     ("intro" (include-template "templates/intro.html"))
     ("howto" (include-template "templates/howto.html"))
     ("expre" (include-template "templates/expre.html"))
     ("eval" (include-template "templates/eval.html"))
     ("conds" (include-template "templates/conds.html"))
     ("functions" (include-template "templates/functions.html"))
     
     ("lists" (include-template "templates/lists.html"))
     ("modules" (include-template "templates/modules.html"))
     ("macros" (include-template "templates/macros.html"))
     ;("objects" (include-template "templates/objects.html"))
     ("where" (include-template "templates/where.html"))
     ("end" (include-template "templates/end.html")))))
...
(define (intro request)
    (make-response
     (include-template "templates/intro.html"))) 
	 
;; howto page
(define (howto request)
    (make-response
     (include-template "templates/howto.html"))) 
	 
;; daten typen / expre page
(define (expre request)
    (make-response
     (include-template "templates/expre.html")))
	 
;; auswerten / eval page
(define (evalu request)
    (make-response
     (include-template "templates/eval.html"))) 
	
;; functions page
(define (functions request)
    (make-response
     (include-template "templates/functions.html"))) 
	 
;; wahrheitswerte / predicate page
(define (predicate request)
    (make-response
     (include-template "templates/predicate.html"))) 
	 
;; bedingte ausdruecke / cond page
(define (conds request)
    (make-response
     (include-template "templates/conds.html"))) 
	 
;; sonder regeln / special  page
(define (special request)
    (make-response
     (include-template "templates/special.html"))) 
 
 (define (sexpr request)
    (make-response
     (include-template "templates/sexpr.html"))) 
	 
(define (createlist request)
    (make-response
     (include-template "templates/createlist.html"))) 
	 
(define (listfunc request)
    (make-response
     (include-template "templates/listfunc.html"))) 
	 
(define (enviroment request)
    (make-response
     (include-template "templates/enviroment.html"))) 
	 
(define (evalproc request)
    (make-response
     (include-template "templates/evalproc.html"))) 
	 
(define (loc request)
    (make-response
     (include-template "templates/loc.html"))) 
